...
public class OneToManyBag {
	...
	public static void main(String [] arg){
		 ...
		 * PARA ESTE CASO ES NECESARIO PASAR POR PARAMETRO ITEM A BID
		 * NO CREO QUE SE CUMPLA LA PERSISTENCIA POR ALCANCE
		 * */
